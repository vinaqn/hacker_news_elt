...
from orchestration.defs.schedules.every_minute import amazon_s3_every_minute,earthquake_api_every_minute

defs=Definitions(
    assets=[*airbyte_assets,dbt_warehouse],
    jobs=[amazon_s3_job,earthquake_api_job],
    schedules=[amazon_s3_every_minute,earthquake_api_every_minute],
    resources={
